...
<body>
    ...
    @section('content')
        <div class="py-2 px-3">
                ...
                <div class="row">
                    <div class="py-3 px-5 bg-light rounded-3 border col-xl-6  w-100">
                        <div class="mb-3 text-center">
                            ...
                            <h4 class="fw-bold">Masukkan Data Barang</h4>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="kode_narang" class="form-label">Kode Barang</label>
            ...
            @enderror"
                                    type="text" name="harga_barang" id="harga_barang" value="{{ old('harga_barang') }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control @error('desc_barang') is-invalid
            @enderror"
                                    type="text" name="desc_barang" id="desc_barang" value="{{ old('desc_barang') }}"
